...
네 빈 서비스와 두 Railway 환경의 싱가포르 설정을 확인했다. CLI 인증도 연결됐다. 앱 준비·시험 배포·운영 배포 플래그는 아직 비활성이다. 운영 서비스 이미지·운영 인증·PostgreSQL·도메인·실제 연동·전체 검수가 남아 있으며 이 변경만으로 다른 사람이 쓸 수 있는 서비스가 배포되지는 않는다.
